...
public class Drivetrain extends TunerSwerveDrivetrain implements Subsystem {
  ...
  Matrix<N3, N1> stdDevsVision = VecBuilder.fill(0.7, 0.7, Math.PI);
  ...
  public void periodic() {
    ...
    if (DriverStation.isDisabled()) {
      ...
      if (poseEstimate.tagCount >= 2) {
        this.setVisionMeasurementStdDevs(this.stdDevsVision);
  ...
  //
  //    /* SysId routine for characterizing translation. This is used to find PID gains for the
  // drive motors. */
